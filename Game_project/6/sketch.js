...
function startGame()
{
	...
	collectables = [
		...
		{x_pos: 590, y_pos: 270, size: 50, isFound: false},
...
function draw()
{
	...
	if(lives < 1)
	{
		...
		noStroke();
		textSize(30);
		text("Game over. Press space to continue.",width/2-textWidth("Game over. Press space to continue.")/2,height/2);
	}
	...
	if(flagpole.isReached)
	{
		...
		noStroke();
		textSize(30);
		text("Level complete. Press space to continue.",width/2-textWidth("Level complete. Press space to continue.")/2,height/2);
	}
