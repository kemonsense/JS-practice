...
function draw()
{
	...
	console.log('x '+robot1_x)
	console.log('y '+robot1_y)
	...
	//for robot both
	if (round(robot1_x) == round(robot2_x+100) || round(robot2_x) == round(robot1_x+100)){
		robot1Speed_x = robot1Speed_x*-1;
		robot2Speed_x = robot2Speed_x*-1;
		console.log('x')
	}

	if (round(robot1_y) == round(robot2_y+100) || round(robot2_y) == round(robot1_y+100)){
		robot1Speed_y = robot1Speed_y*-1;
		robot2Speed_y = robot1Speed_y*-1;
		console.log('y')
	}
