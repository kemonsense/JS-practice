...
function draw()
{
	...
	//draw the sun
	fill(255, 255, 0);
	ellipse(sun.x, sun.y+darkness, sun.diameter);
	...
	fill(70,200,0);
	ellipse(tree.x+20,tree.y-150,tree.canopyWidth,tree.canopyHeight);

    //cloud drawing
	fill(255,255,255,250)
	ellipse(50+darkness,50,60,50);
	ellipse(80+darkness,40,60,50);
	ellipse(130+darkness,50,60,50);
	ellipse(70+darkness,70,60,50);
	ellipse(110+darkness,65,60,50);
	...
	fill(0,0,0,min(darkness,120));
	rect(0,0,width,height);

	//Moon drawing
	fill(255, 255, 255, moon.brightness+darkness);
