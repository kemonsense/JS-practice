...
function draw()
{
	...
	if (redButton.activated == true )
	{
		...
		if (alertFlash == true && frameCount / 30 == parseInt(frameCount / 30))
		{
			textSize(35);
			text("ALART!!!", width / 2, height / 2 - redButton.dia);
		}
	...
	noFill();
	stroke(255, 100, 100);
	arc(redButton.x, redButton.y, redButton.dia, redButton.dia, PI, PI * 3);
